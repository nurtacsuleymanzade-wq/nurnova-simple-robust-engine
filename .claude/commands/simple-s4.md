...
Allowed files:
src/simple/quality_weight_engine.py, src/simple/run_s4_quality_weight.py, tests/simple/test_quality_weight_engine.py
README.md small section only.

Validation:
python -m compileall src
python -m pytest -q tests/simple/test_quality_weight_engine.py
