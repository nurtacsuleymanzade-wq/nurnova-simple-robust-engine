...
Allowed files:
src/simple/trade_plan_decision_engine.py, src/simple/run_s7_trade_plan_decision.py, tests/simple/test_trade_plan_decision_engine.py
README.md small section only.

Validation:
python -m compileall src
python -m pytest -q tests/simple/test_trade_plan_decision_engine.py
