...
Allowed files:
src/simple/paper_outcome_tracker.py, src/simple/run_s8_paper_outcome.py, tests/simple/test_paper_outcome_tracker.py
README.md small section only.

Validation:
python -m compileall src
python -m pytest -q tests/simple/test_paper_outcome_tracker.py
