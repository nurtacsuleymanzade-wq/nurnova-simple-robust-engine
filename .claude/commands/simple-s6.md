...
Allowed files:
src/simple/setup_candidate_engine.py, src/simple/run_s6_setup_candidate.py, tests/simple/test_setup_candidate_engine.py
README.md small section only.

Validation:
python -m compileall src
python -m pytest -q tests/simple/test_setup_candidate_engine.py
