...
Allowed files:
src/simple/edge_stats_engine.py, src/simple/run_s9_edge_stats.py, tests/simple/test_edge_stats_engine.py
README.md small section only.

Validation:
python -m compileall src
python -m pytest -q tests/simple/test_edge_stats_engine.py
