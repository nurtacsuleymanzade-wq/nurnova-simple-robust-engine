...
def test_registry_output_fields_present():
    result = compute_model_registry(_ar01(), _daf(), _fcr(), _cqe())
...
def test_consensus_threshold_computes_correctly():
    short_consensus = compute_model_registry(_ar01(), _daf(), None, _cqe())
    ...
    neutral_consensus = compute_model_registry(_ar01(), None, balanced_fcr, _cqe())
