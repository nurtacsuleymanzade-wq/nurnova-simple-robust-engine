...
_ACTIVE_CHAIN_STAGES: list[tuple[str, str, str]] = [
    ...
    ("src.simple.run_setup_contract_engine", "NOARG", "SETUP_CONTRACT_ENGINE"),
    ...
    ("src.simple.volume_profile_engine", "NOARG", "REAL_VOLUME_PROFILE_ENGINE"),
    ("src.simple.unified_context_engine", "NOARG", "UNIFIED_CONTEXT_ENGINE"),
    ("src.simple.structure_quality_engine", "NOARG", "STRUCTURE_QUALITY_ENGINE"),
    ("src.simple.zone_context_engine", "NOARG", "ZONE_CONTEXT_ENGINE"),
    ...
    ("src.edge.elite_context_detector", "NOARG", "ELITE_CONTEXT_DETECTOR"),
